                    ...
                    if (testCell === LIVE_CELL)
                        {
                            if(testCellPast != LIVE_CELL)
                            {
                                //console.log(j);
                                //play note
                                gainNodeList[gridWidth%32].gain.value = 1;
...
function startOsc()
{
    ...
    for(x=0; x<32; x++)
    {
        ...
        gainNodeList[x].gain.value = -1;
        oscillatorList[x].start();
...
var myTable = context.createPeriodicWave(real, imag);
    ...
    for (var i =0; i < 32; i++){
        ...
        oscillator_.setPeriodicWave(myTable);
